...
\cmnt{MulteFire ~\cite{} is proposed LTE small cell technology for standalone operation in unlicensed spectrum. Similar to LAA, it uses LBT mechanism to do over the air contention as it has been designed keeping in mind the 5 GHz unlicensed spectrum band which has LBT requirmenet in many markets. Therefore In long range whitespace networks it will face similar MAC inefficiencies as 802.11 af.}
